...
def demold_roi(boxes, window, original_image_shape, image_shape):
...
def pretty_plot_confusion_matrix(df_cm, annot=True, cmap="Oranges", fmt='.2f', fz=11,
    ...
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 75, fontsize = 20)
    ...
    ax.set_xlabel(xlbl,fontsize=26)
    ax.set_ylabel(ylbl,fontsize=26)
